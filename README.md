...
This is fork of [jung-kurt/gofpdf](https://github.com/jung-kurt/gofpdf) which has been archived and is not maintained anymore.
...
gofpdf has few dependencies other than the Go standard library.
