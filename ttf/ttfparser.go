...
func (t *parser) ParseComponents() (err error) {
	err = t.ParseHead()
	if err == nil {
		err = t.ParseHhea()
		if err == nil {
...
func (t *parser) ParseHead() (err error) {
	err = t.Seek("head")
...
func (t *parser) ParseHhea() (err error) {
	err = t.Seek("hhea")
	if err == nil {
		t.Skip(4 + 15*2)
...
func (t *parser) ParseMaxp() (err error) {
	err = t.Seek("maxp")
	if err == nil {
		t.Skip(4)
...
func (t *parser) ParseHmtx() (err error) {
	err = t.Seek("hmtx")
	if err == nil {
...
func (t *parser) ParseCmap() (err error) {
	var offset int64
...
func (t *parser) ParseName() (err error) {
	err = t.Seek("name")
	if err == nil {
...
func (t *parser) ParseOS2() (err error) {
	err = t.Seek("OS/2")
	if err == nil {
...
func (t *parser) ParsePost() (err error) {
	err = t.Seek("post")
	if err == nil {
		t.Skip(4) // version
...
func (t *parser) Seek(tag string) (err error) {
	ofs, ok := t.tables[tag]
	if ok {
...
func (t *parser) Skip(n int) {
	t.f.Seek(int64(n), os.SEEK_CUR)
}

func (t *parser) ReadStr(length int) (str string, err error) {
	var n int
...
func (t *parser) ReadUShort() (val uint16) {
	binary.Read(t.f, binary.BigEndian, &val)
	return
}

func (t *parser) ReadShort() (val int16) {
	binary.Read(t.f, binary.BigEndian, &val)
	return
}

func (t *parser) ReadULong() (val uint32) {
	binary.Read(t.f, binary.BigEndian, &val)
	return
}
